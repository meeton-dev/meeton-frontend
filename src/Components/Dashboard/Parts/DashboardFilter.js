            ...
            >
                <div className="create-infos">
                    ...
                    <div className="head">
                        ...
                        <p>Before you start don't forget some important thing, what could help to specify each meetings you creating!</p>
                    </div>
                    <div className="validations">
                        ...
                        <ul>
                            ...
                            <li>If you want, you can add a some goal and topic you have to discuss!</li>
                ...
                <div className="create-content">
                    <Button type="primary" size='small' onClick={() => dispatch(meetingActions.createMeeting())}>
                        Create meeting
                    </Button>
                </div>
            </ MtnModal>
